...
namespace ABS
{
    public class StudioCreator : EditorWindow
    {
        ...
        [MenuItem("Assets/" + EngineGlobal.PROJECT_NAME + "/Studio Creator")]
        ...
        protected void CreateScene()
        {
            ...
            else
            {
                EditorUtility.DisplayDialog("Error",
                    "The scene _StudioTemplate was not found in " + EngineGlobal.PROJECT_PATH_NAME + "/Template folder. This scene is required by the New Studio Creator.",
                    "OK");
            }
        }
    }
