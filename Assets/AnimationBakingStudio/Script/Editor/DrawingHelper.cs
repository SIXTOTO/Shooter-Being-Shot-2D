...
namespace ABS
{
    public class DrawingHelper
    {
        ...
        public static bool DrawNarrowButton(string title, int width = 0)
        {
            ...
            style.fontSize = EditorGlobal.NARROW_BUTTON_FONT_SIZE;

            if (width == 0)
                return GUILayout.Button(title, style, GUILayout.Height(EditorGlobal.NARROW_BUTTON_HEIGHT));
            else
                return GUILayout.Button(title, style, GUILayout.Width(width), GUILayout.Height(EditorGlobal.NARROW_BUTTON_HEIGHT));
        }
        ...
        public static bool DrawNarrowButton(GUIContent content, int width = 0)
        {
            ...
            if (width == 0)
                return GUILayout.Button(content, style, GUILayout.Height(EditorGlobal.NARROW_BUTTON_HEIGHT));
            else
                return GUILayout.Button(content, style, GUILayout.Width(width), GUILayout.Height(EditorGlobal.NARROW_BUTTON_HEIGHT));
        }

        public static bool DrawMiddleButton(string title)
        {
            GUIStyle style = new GUIStyle("button");
            style.fontSize = EditorGlobal.MIDDLE_BUTTON_FONT_SIZE;

            EditorGUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            bool previewUpdateClicked = GUILayout.Button(title, style, GUILayout.Width(EditorGlobal.MIDDLE_BUTTON_WIDTH), GUILayout.Height(EditorGlobal.MIDDLE_BUTTON_HEIGHT));
            GUILayout.FlexibleSpace();
        ...
        public static bool DrawMiddleButton(GUIContent content)
        {
            ...
            EditorGUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            bool previewUpdateClicked = GUILayout.Button(content, style, GUILayout.Width(EditorGlobal.MIDDLE_BUTTON_WIDTH), GUILayout.Height(EditorGlobal.MIDDLE_BUTTON_HEIGHT));
            GUILayout.FlexibleSpace();
            EditorGUILayout.EndHorizontal();
        ...
        {
            GUIStyle style = new GUIStyle("button");
            style.fontSize = EditorGlobal.WIDE_BUTTON_FONT_SIZE;
            return GUILayout.Button(title, style, GUILayout.Height(EditorGlobal.WIDE_BUTTON_HEIGHT));
        }
        ...
        public static bool DrawWideButton(GUIContent content)
        {
            GUIStyle style = new GUIStyle("button");
            style.fontSize = EditorGlobal.WIDE_BUTTON_FONT_SIZE;
            return GUILayout.Button(content, style, GUILayout.Height(EditorGlobal.WIDE_BUTTON_HEIGHT));
        }
    }
}
